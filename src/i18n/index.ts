...
const resources = {
  en: {
    translation: {
      ...
      'please wait while we process your data': 'Please wait while we process your data...',
  ...
  es: {
    translation: {
      ...
      'please wait while we process your data': 'Por favor espere mientras procesamos sus datos...',
